...
using CheMa.VNext.Vehicles.Exceptions;
using CheMa.VNext.Vehicles.Inputs;
using CheMa.VNext.Vehicles.Repositories;
using Volo.Abp.Application.Dtos;
using Volo.Abp.Domain.Repositories;

namespace CheMa.VNext.Vehicles.ApplicationServices;
...
public class VehicleAppService : VNextAppService, IVehicleAppService
{
    ...
    public async Task<VehicleDto> UpdateAsync(Guid id, UpdateVehicleDto input)
    {
        ...
        vehicle.SetVehicleProfile(input.Brand, input.Series, input.Model);
