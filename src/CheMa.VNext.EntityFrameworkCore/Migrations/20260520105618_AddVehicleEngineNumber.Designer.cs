...
namespace CheMa.VNext.Migrations
{
    ...
    [Migration("20260520105618_AddVehicleEngineNumber")]
    partial class AddVehicleEngineNumber
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CheMa.VNext.OpenPlatform.Entities.OpenApiAccessLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppOpenApiAccessLogs", (string)null);
                });

            modelBuilder.Entity("CheMa.VNext.OpenPlatform.Entities.OpenApp", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("AppSecretCipherText")
                        .IsRequired()
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)");

                    b.Property<string>("AppSecretMaskedHint")
                        .IsRequired()
                        .HasMaxLength(32)
                    ...
                    b.ToTable("AppOpenApps", (string)null);
                });

            modelBuilder.Entity("CheMa.VNext.OpenPlatform.Entities.VehicleControlAuthorization", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("VendorDeviceId")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.HasIndex("VehicleId", "AuthorizationStartTime", "AuthorizationEndTime");

                    b.ToTable("AppVehicleControlAuthorizations", (string)null);
                });

            modelBuilder.Entity("CheMa.VNext.VehicleDevices.Entities.VehicleDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CheMa.VNext.Vehicles.Entities.Vehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
