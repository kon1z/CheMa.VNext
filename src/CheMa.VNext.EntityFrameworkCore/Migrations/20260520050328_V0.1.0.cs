        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Series = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    Model = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    VendorType = table.Column<int>(type: "integer", nullable: true),
                    BindingStatus = table.Column<int>(type: "integer", nullable: false),
                    BindingTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppVehicleControlAuthorizations_VehicleId_AuthorizationStar~",
                table: "AppVehicleControlAuthorizations",
                columns: new[] { "VehicleId", "AuthorizationStartTime", "AuthorizationEndTime" });

            migrationBuilder.CreateIndex(
                name: "IX_AppVehicleControlAuthorizations_VehicleVin",
                table: "AppVehicleControlAuthorizations",
                column: "VehicleVin");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "AppVehicleDevices",
                columns: new[] { "VendorType", "VendorDeviceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppVehicles_Vin",
                table: "AppVehicles",
                column: "Vin",
                unique: true);
